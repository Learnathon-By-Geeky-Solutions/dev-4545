...
const EmployeeDetails = () => {
  ...
  const getFeatureStatus = (startDate, endDate) => {
    ...
    if (now < start)
      return { text: "Upcoming", color: "blue", status: "processing" };
    if (now > end)
      return { text: "Completed", color: "green", status: "success" };
                          ...
                          <Col xs={24} md={12}>
                            <Space>
                              ...
                              <Tooltip title={feature.featureId}>
                                <Text
                                  copyable={{ text: feature.featureId }}
                                  style={{
                                    maxWidth: "150px",
                                    overflow: "hidden",
                                    textOverflow: "ellipsis",
                          ...
                          <Col xs={24} md={12}>
                            <Space>
                              ...
                              <Tooltip title={feature.projectId}>
                                <Text
                                  copyable={{ text: feature.projectId }}
                                  style={{
                                    maxWidth: "150px",
                                    overflow: "hidden",
                                    textOverflow: "ellipsis",
              ...
              {projects && projects.length > 0 ? (
                projects.map((project) => (
                  <Badge.Ribbon
                    ...
                    text={
                      isProjectActive(project.endDate) ? "Active" : "Completed"
                    }
